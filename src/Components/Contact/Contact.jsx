  ...
  return (
    <div className='container my-5'>
      ...
      <div className='row py-4'>
        ...
        <div className="col-8 ">
          <div className="card p-4 rounded shadow-sm border-0">
          <form action="">
            <div className=' d-flex justify-content-between'>
              <input type="text" placeholder='Your Name'  className=' border-0 bg-secondary-subtle my-4 p-2 rounded'/>
              <input type="email" placeholder='Your Email' className=' border-0 bg-secondary-subtle my-4 p-2 rounded' />
              <input type="text" placeholder='Your Phone'  className=' border-0 bg-secondary-subtle my-4 p-2 rounded'/>
            </div>
